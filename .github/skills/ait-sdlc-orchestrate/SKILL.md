...
Follow the shared contract in `.github/instructions/ai-sdlc.instructions.md` and `AGENTS.md`.
...
2. Classify difficulty (Simple/Medium/Hard) per the instructions. `/product-run` always uses full
   tracking.
3. Follow the **lifecycle DAG** (instructions): schedule plan‑phase tasks first —
