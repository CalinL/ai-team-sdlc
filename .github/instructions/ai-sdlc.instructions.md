---
description: 'Shared conventions for the AI‑SDLC agentic system: tracking store, task schema, handoff contract, quality gates, resumability, and human‑in‑the‑loop rules. Applies to every agent and skill in this repo.'
applyTo: '**'
---

# AI‑SDLC — Shared Instructions

These are the authoritative conventions for every specialist agent and skill in this system.
They are referenced (not duplicated) by the individual skills. See `AGENTS.md` for the quick
version and `docs/ai-sdlc-design.md` for the design rationale.
